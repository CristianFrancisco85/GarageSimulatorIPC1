...
public class SimpleCircularLinkedList<T> {
    ...
    public void addEnd(T value){
        ...
        SimpleNode<T> nuevo = new SimpleNode();
    ...
    /**
     * Inserta un nuevo nodo despues de del nodo con el valor indicado
     * @param refValue valor del nodo anterior al nuevo nodo a insertar.
    ...
    public void addByValue(T refValue, T valor){
        ...
        if (!isEmpty()) {
            if (Search(refValue)) {
                ...
                SimpleNode siguiente = aux.getNext();
